...
class TestViews(TestCase):
    def setUp(self):
        ...
        self.logged_in = self.client.login(
            username=self.test_user_1.username, password="PasswordExample123!"
        )
    ...
    def test_views_home_context(self):
        test_post = Post.objects.create(
            user=self.test_user_2, description="test description"
        )
        Follow.objects.create(
            user=self.test_user_1,
            user_followed=self.test_user_2,
            followd_user_id=self.test_user_2.id,
        )
        test_comment = Comment.objects.create(
            post=test_post, user=self.test_user_1, text="test comment"
        )
    ...
    def test_views_sign_up_POST_incorrect_data(self):
        ...
        )  # value=2, because of creation users in setUp
        self.assertEqual(
            UserProfile.objects.count(), 2
        )  # value=2, because of creation profiles in setUp
    ...
    def test_views_edit_account_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/edit_account/")
        )
    ...
    def test_views_edit_profile_if_not_logged_in(self):
        ...
        response = self.client.get(
            reverse("edit_profile", kwargs={"id": self.test_user_1.id})
        )

        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/edit_profile/")
        )
    ...
    def test_views_user_profile_if_not_logged_in(self):
        self.client.logout()
        response = self.client.get(
            reverse("user_profile", kwargs={"id": self.test_user_1.id})
        )

        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/profile/")
        )
    ...
    def test_views_user_profile_GET_context(self):
        ...
        self.assertEqual(
            list(response.context["posts"]), list(self.test_user_1.posts.all())
        )
    ...
    def test_view_user_profile_follow_context_postivie(self):
        ...
        response = self.client.get(
            reverse("user_profile", kwargs={"id": self.test_user_2.id})
        )
    ...
    def test_views_add_post_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/add_post")
        )
    ...
    def test_view_add_post_POST(self):
        with open("media_dir\posts_imgs\david_brown_post_1.jpg", "rb") as img:
            response = self.client.post(
                reverse("add_post"),
                {"post_img": img, "description": "post test description"},
            )
        ...
        self.assertEqual(
            self.test_user_1_profile.posts_amount, self.test_user_1.posts.count()
        )
    ...
    def test_view_edit_post_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/edit_post")
        )

    def test_view_edit_post_GET(self):
        test_post = Post.objects.create(
            user=self.test_user_1, description="test description"
        )
    ...
    def test_view_edit_post_POST_positive(self):
        ...
        with open("media_dir\posts_imgs\david_brown_post_1.jpg", "rb") as img:
            response = self.client.post(
                reverse("edit_post", kwargs={"id": test_post.id}),
                {"post_img": img, "description": "after editing"},
            )
    ...
    def test_view_delete_post_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/delete_post")
        )
    ...
    def test_view_add_comment_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/add_comment")
        )
    ...
    def test_view_add_comment_POST_with_data(self):
        ...
        response = self.client.post(
            reverse("add_comment", kwargs={"post_id": test_post.id}),
    ...
    def test_view_delete_comment_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/delete_comment")
        )
    ...
    def test_view_delete_comment(self):
        ...
        response = self.client.get(
            reverse("delete_comment", kwargs={"id": test_comment.id})
        )
    ...
    def test_view_thumb_up_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/thumb_up")
        )
    ...
    def test_view_follow_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/follow")
        )
    ...
    def test_view_unfollow_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/unfollow")
        )
    ...
    def test_view_unfollow_if_follow_not_exists(self):
        ...
        Follow.objects.create(
            ...
            user_followed=self.test_user_1,
            followd_user_id=self.test_user_1.id,
        )
    ...
    def test_view_search_if_not_logged_in(self):
        ...
        self.assertTrue(
            response.url.startswith("/instagram/login/?next=/instagram/search")
        )

    def test_view_search_GET_with_correct_data(self):
        response = self.client.get(
            reverse("search"), {"username_search": self.test_user_2.username}
        )

        self.assertRedirects(
            response, f"/instagram/profile/{self.test_user_2_profile.id}"
        )
